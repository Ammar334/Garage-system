...
# 53 "./ECU_layer/DC_Motor/../../MCAL_layer/GPIO/../Timer0/Timer0.h"
typedef enum
{
...
# 57 "./ECU_layer/DC_Motor/../../MCAL_layer/GPIO/../Timer2/Timer2.h"
typedef struct
{
...
# 52 "./ECU_layer/DC_Motor/../../MCAL_layer/GPIO/../Timer3/Timer3.h"
typedef struct
{
...
# 69 "./ECU_layer/DC_Motor/../../MCAL_layer/GPIO/../CCP/CCP1.h"
typedef enum
{
...
int main() {
    ...
    while(1)
    {
        ...
        if((pir1_state == 1)&&(numper_places>0)&&(pir1_flag == 0))
        {
            numper_places--;
            pir1_flag = 1;
            ret = convert_byte_to_string(numper_places,numper_places_str);
        ...
        else if(pir1_state == 0)
        {
            pir1_flag = 0;
        }
        ret = PIR_sensor_read(&pir2,&pir2_state);
        if((pir2_state == 1)&&(numper_places<5)&&(pir2_flag == 0))
        {
            numper_places++;
            pir2_flag = 1;
            ret = convert_byte_to_string(numper_places,numper_places_str);
